...
public class buscar_esepcial extends javax.swing.JInternalFrame {
DefaultTableModel modelo;
 private TableRowSorter trsFiltro;
    /** Creates new form ClientesB */
    public buscar_esepcial() {
        initComponents();
        mostrarclientes("");
    ...
    private void tbclientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbclientesMouseClicked
        ...
        try {
            ...
            else
            {
                ...
                especial.txt1.setDisabledTextColor(Color.blue);
                especial.txt1.setText(nom);
                especial.txt3.setDisabledTextColor(Color.blue);
                especial.txt3.setText(ape);
                especial.txt4.setDisabledTextColor(Color.blue);
     	        especial.txt4.setText(diag);
                especial.txt5.setDisabledTextColor(Color.blue);
                especial.txt5.setText(fecha);
                especial.txt6.setDisabledTextColor(Color.blue);
                especial.txt6.setText(nivel);
                especial.txt7.setDisabledTextColor(Color.blue);
                especial.txt7.setText(di);

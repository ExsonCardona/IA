...
public class buscar_ocupacional extends javax.swing.JInternalFrame {
DefaultTableModel modelo;
 private TableRowSorter trsFiltro;
    /** Creates new form ClientesB */
    public buscar_ocupacional() {
        initComponents();
        mostrarclientes("");
    ...
    private void tbclientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbclientesMouseClicked
        ...
        try {
            ...
            else
            {
                ...
                tocupacional.txt1.setDisabledTextColor(Color.blue);
               tocupacional.txt1.setText(nom);
               tocupacional.txt3.setDisabledTextColor(Color.blue);
               tocupacional.txt3.setText(ape);
               tocupacional.txt4.setDisabledTextColor(Color.blue);
               tocupacional.txt4.setText(diag);
               tocupacional.txt5.setDisabledTextColor(Color.blue);
               tocupacional.txt5.setText(fecha);
               tocupacional.txt6.setDisabledTextColor(Color.blue);
               tocupacional.txt6.setText(nivel);
               tocupacional.txt7.setDisabledTextColor(Color.blue);
               tocupacional.txt7.setText(di);

...
public class grafica extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form graficaprueba
     */
    ...
    public grafica() {
        ...
        String Sql= "select indicador_sensorial, indicador_tiempo, indicador_intelectual from terapia where paciente_id = " + idbuscar + " order by id DESC limit 1;";
       // String Sql1= "select indicador_tiempo from terapia where paciente_id = 1 order by id DESC limit 1;";
        //String Sql2= "select indicador_intelectual from terapia where paciente_id = 1 order by id DESC limit 1;";
        try {
             Statement st = cn.createStatement();
             ResultSet rs = st.executeQuery(Sql);
             while(rs.next()){
              valorIsensorial= rs.getInt("indicador_sensorial");
              valorItiempo= rs.getInt("indicador_tiempo");
              valorIintelectual= rs.getInt("indicador_intelectual");
             } 
        ...
        JFreeChart grafico_barras = ChartFactory.createBarChart3D("Estadísticas de ultima sesión","Paciente: " + nombrepaciente + " " + apellidopaciente, "Resultados",datos, PlotOrientation.VERTICAL, true, true, false);
